// Created by Tyrell Rummage
// Hosted on https://codepen.io/tyrellrummage/pen/dOyxJv
...
var width = document.getElementById("animation-col").clientWidth;
var height = document.getElementById("animation-col").clientHeight;
...
var nodeSize = 6; //node size (radius)
var speed = 0.1; //base speed (added to each node random speed)
var nodeAmount = 30; //node amount, the more the slower
...
function Node(x, y, id) {
	...
	this.speedX = (speed * randomInt(-100, 100)) / 100;
	this.speedY = (speed * randomInt(-100, 100)) / 100;
...
window.addEventListener("resize", function() {
	width = document.getElementById("animation-col").offsetWidth;
	height = document.getElementById("animation-col").offsetHeight;
